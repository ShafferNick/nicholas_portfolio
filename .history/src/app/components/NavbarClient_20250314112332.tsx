    ...
    <nav className="bg-transparent text-white p-4 sticky top-0 z-10">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-8">
        ...
        <div className="md:hidden relative mobile-menu-toggle">
          ...
          {/* Mobile Menu */}
          <div
            className={`md:hidden fixed top-0 right-0 w-64 h-screen bg-gray-200 p-6 pt-16 box-border overflow-y-auto transform transition-transform duration-500 ease-[cubic-bezier(0.77,0.2,0.05,1.0)] z-50 mobile-menu ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
          >
