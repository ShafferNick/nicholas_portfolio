  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-gray-800 py-16 md:py-24 text-center animate-slide-in">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Nicholas Shaffer</h1>
          <div className="max-w-2xl mx-auto px-4">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">Professional Summary</h3>
            <p className="text-base md:text-lg leading-relaxed">{profile.summary}</p>
          </div>
          <a
            href="/contact"
            className="mt-8 inline-block bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-full text-lg font-semibold transition-colors animate-slide-in"
          >
            Contact Me <span className="ml-2">✈️</span>
          </a>
          <div className="mt-12">
            <div className="w-48 h-48 md:w-64 md:h-64 bg-gray-700 mx-auto rounded-full overflow-hidden animate-slide-in">
