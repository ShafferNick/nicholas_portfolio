    ...
    <nav className="bg-transparent text-white p-4 sticky top-0 z-10">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6">
        ...
        <div className="md:hidden relative">
          ...
          {/* Mobile Menu */}
          {isOpen && (
            <div className="md:hidden fixed top-0 right-0 w-64 max-h-screen bg-gray-200 p-6 pt-32 box-border overflow-y-auto transform translate-x-full transition-transform duration-500 ease-[cubic-bezier(0.77,0.2,0.05,1.0)] z-10">
