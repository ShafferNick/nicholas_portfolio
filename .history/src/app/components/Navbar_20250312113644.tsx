...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gray-900 p-4 fixed top-0 w-full z-10 shadow-md">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <h1 className="text-xl md:text-2xl font-bold text-left">Nicholas Shaffer</h1>
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-center space-y-2 bg-gray-800 p-4 rounded-b-lg">
