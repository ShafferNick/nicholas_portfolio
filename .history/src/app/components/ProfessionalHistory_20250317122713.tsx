...
export default function ProfessionalHistory({ jobs }: ProfessionalHistoryProps) {
  ...
  return (
    <section className="professional-history-section py-6 bg-[#EFF0F3] animate-slide-in w-full">
        ...
        <Slider {...settings}>
          {jobs.map((job) => (
            <div key={job._id} className="px-2">
              <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col h-[350px] transition-transform duration-300 hover:shadow-xl">
