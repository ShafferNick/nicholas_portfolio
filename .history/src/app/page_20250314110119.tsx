...
import NavbarClient from '/Users/nicholasshaffer/projects/nicholas-portfolio/src/app/components/NavbarClient.tsx'; // Adjust path as needed
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col mx-8">
      <NavbarClient />
      <main className="flex-grow max-w-6xl mx-auto px-8">
        ...
        <section className="badge-social-section">
          ...
          <div className="social-links">
            <a href="https://example.com" target="_blank" rel="noopener noreferrer">
              <img src="/badge1.png" alt="Badge 1" className="social-link-img" />
            </a>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer">
              <img src="/github.png" alt="GitHub" className="social-link-img" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
              <img src="/linkedin.png" alt="LinkedIn" className="social-link-img" />
            </a>
          </div>
        </section>
