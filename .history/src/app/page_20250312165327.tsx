      ...
      <main className="flex-grow">
        ...
        <section className="hero-custom-black py-16 md:py-24 text-left animate-slide-in">
          <div className="max-w-4xl mx-auto px-4">
            <h1 className="text-5xl md:text-7xl font-extralight mb-4" style={{ fontWeight: 200 }}>Nicholas Shaffer</h1>
            ...
            <a
              ...
              <div className="w-65% max-w-[65%] h-20 bg-gray-400 rounded overflow-hidden animate-slide-in">
                <Image
                  ...
                  alt="Banner"
                  width={256} // Adjust width proportionally to 65% of max-w-4xl (e.g., 4xl is 1152px, 65% is ~748px)
                  height={80}  // Slim height, roughly 20% of the original 256px
