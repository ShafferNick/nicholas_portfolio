...
export default function ProfessionalHistory({ jobs }: ProfessionalHistoryProps) {
  const settings = {
    ...
    slidesToScroll: 1,
    arrows: true,
    variableWidth: false, // Ensure consistent width for all slides
    adaptiveHeight: false, // Prevent height from adjusting dynamically
  };

  return (
    <section className="professional-history-section py-8 bg-[#EFF0F3] animate-slide-in w-full">
      <div className="max-w-4xl mx-auto px-8 md:px-12">
        <h2 className="text-5xl md:text-6xl font-bold mb-4 text-left">
