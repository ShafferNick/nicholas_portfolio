      ...
      <main className="flex-grow">
        ...
        <section className="hero-custom-black py-16 md:py-24 text-left animate-slide-in">
          <div className="max-w-4xl mx-auto px-4">
            <h1 className="text-4xl md:text-6xl font-extralight mb-4" style={{ fontWeight: 100 }}>Nicholas Shaffer</h1>
            <div className="max-w-2xl">
              <h3 className="text-sm md:text-base font-extralight mb-2" style={{ fontWeight: 100 }}>Professional Summary</h3>
            ...
            >
              Contact Me <PaperAirplaneIcon className="ml-2 inline-block w-5 h-5" />
            </a>
